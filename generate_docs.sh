...
function doDocs(){
    ...
    (
        ...
        sed -e 's/^PROJECT_NAME *=.*/PROJECT_NAME = "C++ polymorphic approach"/g'  \
            ...
            -e 's/^UML_LIMIT_NUM_FIELDS *=.*/UML_LIMIT_NUM_FIELDS = 5/g' \
